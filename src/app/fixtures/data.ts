...
const data: FixtureCiteI[] = [
  ...
  {cite: `L'art est une démonstration dont la nature est la preuve.`, author: `George Sand`},
  {cite: `L'art d'être tantôt très audacieux et tantôt très prudent est l'art de réussir.`, author: `Napoléon Bonaparte`},
  {cite: `L’amour, c’est la fusion, l’identification de deux êtres qui s’admirent et s’adorent l’un l’autre.`, author: `George Sand`},
  ...
  {cite: `La joie de vivre est une émotion contagieuse.`, author: `Edward D. Wynot`, tags: ['bonheur']},
  {cite: `La beauté commence le jour où tu décides d'être toi-même.`, author: `Coco Chanel`, tags: []},
  {cite: `Quand la vie te donne un lundi, plonge-le dans les paillettes et scintille toue la journée.`, author: `Ella Woodward`, tags: ['bonheur', 'difficultée']},
  {cite: `Sors des sentiers battus. Explore. Rêve. Découvre.`, author: `Mark Twain`, tags: []},
  {cite: `Je ne veux désormais collectionner que les moments de bonheur.`, author: `Stendhal`, tags: ['bonheur']},
  {cite: `Soyez vous-même, les autres sont déjà pris.`, author: `Oscar Wilde`, tags: []},
  {cite: `Je ne perds jamais, soit je gagne, soit j'apprends.`, author: `Nelson Mandela`, tags: []},
  {cite: `Fais de ta vie un rêve, et d'un rêve une réalité.`, author: `Antoinde de Saint-Exupéry`, tags: ['Rêve']},
  {cite: `Il n'y a rien de mieux qu'un ami. Sauf peut-être un ami avec du chocolat.`, author: `Lynda Grayson`, tags: ['amitié']},
  {cite: `Je peux le faire et le ferai. Vous pouvez commencer à regarder.`, author: `Carry Green`, tags: []},
  {cite: `"C'est impossible" di la fierté. "C'est risqué" dit l'expérience. "C'est sans issue" dit la raison."Essayons" mlurmure le coeur.`, author: `William Arthur Ward`, tags: []},
  {cite: `La vie, c'est comme une boîte de chocolats, on ne sait jamais sur quoi on va tomber.`, author: `Winston groom`, tags: ['extrait', 'Forrest Gump']},
  {cite: `Donne à chaque jour la chance de devenir le plus beau jour de ta vie.`, author: `Makr Twain`, tags: ['bonheur']},
  {cite: `Tous les enfants ont du génie, le tout c'est de le faire apparaître.`, author: `Charlie Chaplin`, tags: ['enfance']},
  {cite: `La vie, c'est comme une bicyclette, il faut avancer pour ne pas perdre l'équilibre.`, author: `Albert Einstein`, tags: []},
  {cite: `Il ne faut pas attendre d'être parfait pour commencer quelque chose de bien.`, author: `Abbé Pierre`, tags: []},
  {cite: `J'ai un petit côté sirène. Certains jours, on dirait que je me suis peignée avec une fourchette.`, author: `Emmanuelle Cortes`, tags: []},
  {cite: `Il n'y a aucune limite à ce que nous pouvons accomplir en tant que filles.`, author: `Michelle Obama`, tags: ['féminisme']},
  {cite: `Il y a deux choses qui changent notre vie : les gens que nous rencontrons et les livres que nous lisons.`, author: `Harvey MacKay`, tags: []},
  {cite: `Une journée sans rire est une journée de perdue.`, author: `Charlie Chaplin`, tags: ['rire', 'bonheur']},
  {cite: `N'oublions pas : un livre, un stylo, un enfant et un enseignant peuvent changer le monde.`, author: `Malala Yousazai`, tags: []},
  {cite: `Don't worry, be happy.`, author: `Bob Marley`, tags: ['Chanson']},
  {cite: `I have a dream.`, author: `Martin Luther King`, tags: []},
  {cite: `Neuf personnes sur dix aiment le chocolat ; la dixième ment.`, author: `John G. Tullius`, tags: []},
  {cite: `Mais alors, si le monde n'a absolument aucun sens, qu'est ce qui nous empêche d'en inventer un ?.`, author: `Lewis Caroll`, tags: []},
  {cite: `Le bonheur vient vers ceux qui croient en lui.`, author: `Ali Obn Abu Talib`, tags: ['bonheur']},
  {cite: `Pour être irremplaçable, il faut être différente.`, author: `Coco Chanel`, tags: []},
  {cite: `Être en vacances, c'est n'avoir rien à faire et avoir toute la journée pour le faire.`, author: `Robert Orban`, tags: ['vacance', 'oisiveté']},
  {cite: `On n'a jamais autant besoin de vacances que lorsqu'on en revient.`, author: `Ann Landers`, tags: ['fatigue']},
  {cite: `Celui qui dit que le bonheur ne s'achète pas à oublié qu'il y a les petits chiots.`, author: `Gene Hill`, tags: ['bonheur', 'capitalisme']},
  {cite: `Le secret du bonheuret le comble de l'art, c'est de vivre comme tout le monde, en n'étant comme personne.`, author: `Simone de Beauvoir`, tags: []},
  ...
  {cite: `N'oubliez pas qu'il faut prendre la vie avec sérénité et joie quoi qu'il arrive.`, author: `Rosa Luxembourg`, tags: ['bonheur', 'joie']},
  ...
  {cite: `Prenez-moi tout mais laissez-moi l'extase et je serai plus riche que mes semblables.`, author: `Emily Dickinson`, tags: ['plaisir']},
  {cite: `Quand on a bonne conscience, c'est Noël en permanence.`, author: `Benjamin Franklin`, tags: ['honnêteté']},
  {cite: `Si la vie est un roman, prends ta plume et viens écrire avec moi, les plus beaux chapitres.`, author: `Josiane Coeijmans`, tags: ['amour']},
  {cite: `Notre plus grande faiblesse réside dans l'abandon ; la façon la plus sûre de réussir est d'essayer une autre fois.`, author: `Thomas Edison`, tags: ['succès', 'persévérance']},
  {cite: `Le courage croit en osant et la peur en hésitant.`, author: `Proverbe romain`, tags: ['courage', 'peur']},
  {cite: `Dans les grandes choses, avant l'effort qui réussit, il y a presque toujours des efforts qui passent inaperçus.`, author: `Laure Conan`, tags: []},
  {cite: `Le bonheur, c'est cet instant, cette lueur qui embellit le jour et rejaillit sur autrui.`, author: `Josiane Coeijmans`, tags: ['bonheur']},
  {cite: `Les choses n'arrivent quasi jamais comme on se les imagine.`, author: `Madame de Sévigné`, tags: ['hasard']},
  {cite: `Il n’y a pas plus de raison de trop s’accuser de ses défauts que de s’en trop excuser.`, author: `Madeleine de Souvré`, tags: ['humilité', 'confiance']},
  {cite: `La nature est éternellement jeune, belle et généreuse. Elle verse la poésie et la beauté à tous les êtres, à toutes les plantes, qu'on laisse s'y développer.`, author: `George Sand`, tags: []},
  {cite: `La famille, c'est l'amour sans regrets et sans amertume.`, author: `Ninon de Lenclos`, tags: ['amour']},
  ...
  {cite: `Sans les cadeaux, Noël ne serait pas Noël.`, author: `Louisa May Alcott`, tags: ['noël']},
  ...
  {cite: `Il n'y a pas de vrai bonheur dans l'égoïsme.`, author: `George Sand`, tags: ['partage', 'égoïsme']},
  {cite: `Soyez gais, moquez-vous de tout.`, author: `Rosa Luxembourg`, tags: ['bonheur']},
  {cite: `Un seul homme armé de courage vaut une majorité.`, author: `Andrew Jackson`, tags: []},
  {cite: `Tant que l'on vit, la vie amoureuse est possible.`, author: `Anna De Noailles`, tags: []},
  {cite: `L'amitié sans confiance, c'est une fleur sans parfum.`, author: `Laure  Conan`, tags: []},
  {cite: `Le repos est un rêve ; la vie est un orage.`, author: `George Sand`, tags: []},
  {cite: `Soyez heureux de vivre: cela vous donne une chance d'aimer et de travailler, de vous amuser et de regarder les étoiles.`, author: `Henry Van Dyke`, tags: ['bonheur']},
  {cite: `Il faut tâcher de se surpasser toujours ; cette occupation doit durer autant que la vie.`, author: `Christine De Pisan`, tags: []},
