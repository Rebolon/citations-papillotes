...
var PlatformState = /* @__PURE__ */ (() => {
  const _PlatformState = class _PlatformState {
    constructor(_doc) {
      this._doc = _doc;
    }
    /**
  ...
  let PlatformState2 = _PlatformState;
  return PlatformState2;
})();
var ServerXhr = /* @__PURE__ */ (() => {
  const _ServerXhr = class _ServerXhr {
    ...
    \u0275loadImpl() {
      return __async(this, null, function* () {
        if (!this.xhrImpl) {
          const {
            default: xhr
          } = yield import("./xhr2-7DJT2TCT.mjs");
          this.xhrImpl = xhr;
        }
      });
    }
...
var INITIAL_CONFIG = /* @__PURE__ */ new InjectionToken("Server.INITIAL_CONFIG");
...
var ServerPlatformLocation = /* @__PURE__ */ (() => {
  const _ServerPlatformLocation = class _ServerPlatformLocation {
  ...
  let ServerPlatformLocation2 = _ServerPlatformLocation;
  return ServerPlatformLocation2;
})();
var ServerEventManagerPlugin = /* @__PURE__ */ (() => {
  const _ServerEventManagerPlugin = class _ServerEventManagerPlugin extends EventManagerPlugin {
    constructor(doc) {
      super(doc);
      this.doc = doc;
    }
  ...
  let ServerEventManagerPlugin2 = _ServerEventManagerPlugin;
...
var platformServer = /* @__PURE__ */ createPlatformFactory(platformCore, "server", INTERNAL_SERVER_PLATFORM_PROVIDERS);
...
var SERVER_CONTEXT = /* @__PURE__ */ new InjectionToken("SERVER_CONTEXT");
...
@angular/platform-server/fesm2022/platform-server.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-QYUXFS6W.mjs.map
