...
var routes = [{
  path: "",
  loadComponent: () => import("./home.component-MFVJY6FN.js").then((c) => c.HomeComponent)
  /* */
}, {
  path: "cites",
  loadComponent: () => import("./list-cites.component-E37FREEZ.js").then((c) => c.ListCitesComponent)
  /* */
}, {
  path: "authors",
  loadComponent: () => import("./list-authors.component-GR2Z3YYY.js").then((c) => c.ListAuthorsComponent)
  /* */
}, {
  path: "authors/:author",
  loadComponent: () => import("./list-cites-by-authors.component-NHMGXVSZ.js").then((c) => c.ListCitesByAuthorsComponent)
  /* */
}, {
  path: "random",
  loadComponent: () => import("./random.component-2INP3C2A.js").then((c) => c.RandomComponent)
  /* */
}, {
  path: "search",
  loadComponent: () => import("./list-cites.component-E37FREEZ.js").then((c) => c.ListCitesComponent)
  ...
  path: "**",
  loadComponent: () => import("./page-not-found.component-GRUJOO5B.js").then((c) => c.PageNotFoundComponent)
  /* */
}];
